...
class InfoJoc:
    ...
    def jucator_opus(cls, jucator):
        return InfoJoc.JMAX if jucator == InfoJoc.JMIN else InfoJoc.JMIN
    def final(self):
    ...
    def linii_deschise(self, jucator):  # numarul de linii deschise , numarul de linii pe care poti sa mai castigi
